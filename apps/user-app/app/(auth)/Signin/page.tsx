  ...
  return (
    <div className="space-y-1">
      ...
      <input
        ...
        className="w-full px-4 py-2.5 rounded-lg border dark:border-slate-700 border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all"
        required
      />
    </div>
  );
